...
;(function() {
  ...
  Complety.prototype = {
    ...
    _always: function(json) {
      ...
      this.self.trigger('complety:always', [json, this]);
    },
    ...
    _done: function(json) {
      ...
      this.self.trigger('complety:done', [json, this]);
    },

    _fail: function(json) {
      if (json.statusText !== 'abort') {
        this.self.trigger('complety:fail', [json, this]);
      }
    },
    ...
    search: function(value) {
      this.currentValue = $.trim(value || this.el.value);
    ...
    show: function() {
      ...
      this.self.trigger('complety:suggested', [this.currentSuggestions, this]);
    ...
    suggest: function(suggestion) {
      ...
      this.self.val(value).data('value', value);
